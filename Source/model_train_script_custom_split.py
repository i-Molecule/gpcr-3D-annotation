# This script was used to train random forest, xgboost, svm models on structural distance-based features, derived from a set of GPCRs' pdb files with custom splitting function.
...
#This function was used to split our dataset for model training, to ensure that splitting was done according to the dataset's initial proportion. If you want to train the model on your data, you need to write the splitting function yourself, or use customize this function. 
...
#features split using custom splitting function
